...
async function start() {            // Създаваме функция, която ще стартира всички настройки на нашето приложение
    ...
    app.listen(3000, () => console.log('Server is listening on port 3000...'));  // Настройване приложението да слуша на порт 3000 и подаваме callback да ни изпише като е стартирано
}
