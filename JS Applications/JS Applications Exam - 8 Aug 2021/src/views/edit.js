...
export async function editPage(ctx) {
	...
	const book = await service.getById(id); // Change function name from service and variable name

	ctx.render(editTemplate(book, createSubmitHandler(ctx, onSubmit))); // Change variable name
}
